...
async function checkApproval() {
  if (fs.existsSync(config.filePath)) {
    ...
    console.log(chalk.blue.bold("\n\nScript Membutuhkan Persetujuan Dari Creator, Jika Kamu Sudah Membeli Script Dari " + chalk.yellow.bold("AikoRenn") + " Maka Akan Otomatis Di Setujui!"));
...
console.log(chalk.cyan.bold("Module scriptSecurity loaded successfully"));
